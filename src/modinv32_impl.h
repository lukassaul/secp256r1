...
#ifndef SECP256R1_MODINV32_IMPL_H
#define SECP256R1_MODINV32_IMPL_H
...
#ifdef VERIFY
static const secp256r1_modinv32_signed30 SECP256R1_SIGNED30_ONE = {{1}};

/* Compute a*factor and put it in r. All but the top limb in r will be in range [0,2^30). */
static void secp256r1_modinv32_mul_30(secp256r1_modinv32_signed30 *r, const secp256r1_modinv32_signed30 *a, int alen, int32_t factor) {
...
static int secp256r1_modinv32_mul_cmp_30(const secp256r1_modinv32_signed30 *a, int alen, const secp256r1_modinv32_signed30 *b, int32_t factor) {
    int i;
    secp256r1_modinv32_signed30 am, bm;
    secp256r1_modinv32_mul_30(&am, a, alen, 1); /* Normalize all but the top limb of a. */
    secp256r1_modinv32_mul_30(&bm, b, 9, factor);
    for (i = 0; i < 8; ++i) {
 ...
 * [0,2^30). */
static void secp256r1_modinv32_normalize_30(secp256r1_modinv32_signed30 *r, int32_t sign, const secp256r1_modinv32_modinfo *modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    ...
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, -2) > 0); /* r > -2*modulus */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
    ...
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 0) >= 0); /* r >= 0 */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(r, 9, &modinfo->modulus, 1) < 0); /* r < modulus */
#endif
}
 ...
 */
static int32_t secp256r1_modinv32_divsteps_30(int32_t zeta, uint32_t f0, uint32_t g0, secp256r1_modinv32_trans2x2 *t) {
 ...
 */
static int32_t secp256r1_modinv32_divsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0, secp256r1_modinv32_trans2x2 *t) {
    ...
    /* Transformation matrix; see comments in secp256r1_modinv32_divsteps_30. */
    uint32_t u = 1, v = 0, q = 0, r = 1;
    ...
    for (;;) {
        ...
        zeros = secp256r1_ctz32_var(g | (UINT32_MAX << i));
 ...
 */
static void secp256r1_modinv32_update_de_30(secp256r1_modinv32_signed30 *d, secp256r1_modinv32_signed30 *e, const secp256r1_modinv32_trans2x2 *t, const secp256r1_modinv32_modinfo* modinfo) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    ...
    int i;
#ifdef VERIFY
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, -2) > 0); /* d > -2*modulus */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(d, 9, &modinfo->modulus, 1) < 0);  /* d <    modulus */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, -2) > 0); /* e > -2*modulus */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(e, 9, &modinfo->modulus, 1) < 0);  /* e <    modulus */
 ...
 */
static void secp256r1_modinv32_update_fg_30(secp256r1_modinv32_signed30 *f, secp256r1_modinv32_signed30 *g, const secp256r1_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
 ...
 */
static void secp256r1_modinv32_update_fg_30_var(int len, secp256r1_modinv32_signed30 *f, secp256r1_modinv32_signed30 *g, const secp256r1_modinv32_trans2x2 *t) {
    const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
    const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
    int32_t fi, gi;
    int64_t cf, cg;
...
static void secp256r1_modinv32(secp256r1_modinv32_signed30 *x, const secp256r1_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, zeta=-1. */
    secp256r1_modinv32_signed30 d = {{0}};
    secp256r1_modinv32_signed30 e = {{1}};
    secp256r1_modinv32_signed30 f = modinfo->modulus;
    secp256r1_modinv32_signed30 g = *x;
    int i;
    ...
    for (i = 0; i < 20; ++i) {
        ...
        secp256r1_modinv32_trans2x2 t;
        zeta = secp256r1_modinv32_divsteps_30(zeta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        secp256r1_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        secp256r1_modinv32_update_fg_30(&f, &g, &t);
#ifdef VERIFY
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, 9, &modinfo->modulus, -1) > 0); /* g > -modulus */
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, 9, &SECP256R1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, 9, &SECP256R1_SIGNED30_ONE, -1) == 0 ||
                 secp256r1_modinv32_mul_cmp_30(&f, 9, &SECP256R1_SIGNED30_ONE, 1) == 0 ||
                 (secp256r1_modinv32_mul_cmp_30(x, 9, &SECP256R1_SIGNED30_ONE, 0) == 0 &&
                  secp256r1_modinv32_mul_cmp_30(&d, 9, &SECP256R1_SIGNED30_ONE, 0) == 0 &&
                  (secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, 1) == 0 ||
                   secp256r1_modinv32_mul_cmp_30(&f, 9, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    secp256r1_modinv32_normalize_30(&d, f.v[8], modinfo);
    *x = d;
}

/* Compute the inverse of x modulo modinfo->modulus, and replace x with it (variable time). */
static void secp256r1_modinv32_var(secp256r1_modinv32_signed30 *x, const secp256r1_modinv32_modinfo *modinfo) {
    /* Start with d=0, e=1, f=modulus, g=x, eta=-1. */
    secp256r1_modinv32_signed30 d = {{0, 0, 0, 0, 0, 0, 0, 0, 0}};
    secp256r1_modinv32_signed30 e = {{1, 0, 0, 0, 0, 0, 0, 0, 0}};
    secp256r1_modinv32_signed30 f = modinfo->modulus;
    secp256r1_modinv32_signed30 g = *x;
#ifdef VERIFY
    int i = 0;
    ...
    while (1) {
        ...
        secp256r1_modinv32_trans2x2 t;
        eta = secp256r1_modinv32_divsteps_30_var(eta, f.v[0], g.v[0], &t);
        /* Update d,e using that transition matrix. */
        secp256r1_modinv32_update_de_30(&d, &e, &t, modinfo);
        /* Update f,g using that transition matrix. */
#ifdef VERIFY
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) > 0); /* f > -modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) <= 0); /* f <= modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, -1) > 0); /* g > -modulus */
        VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, len, &modinfo->modulus, 1) < 0);  /* g <  modulus */
#endif
        secp256r1_modinv32_update_fg_30_var(len, &f, &g, &t);
...
#ifdef VERIFY
    /* g == 0 */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&g, len, &SECP256R1_SIGNED30_ONE, 0) == 0);
    /* |f| == 1, or (x == 0 and d == 0 and |f|=modulus) */
    VERIFY_CHECK(secp256r1_modinv32_mul_cmp_30(&f, len, &SECP256R1_SIGNED30_ONE, -1) == 0 ||
                 secp256r1_modinv32_mul_cmp_30(&f, len, &SECP256R1_SIGNED30_ONE, 1) == 0 ||
                 (secp256r1_modinv32_mul_cmp_30(x, 9, &SECP256R1_SIGNED30_ONE, 0) == 0 &&
                  secp256r1_modinv32_mul_cmp_30(&d, 9, &SECP256R1_SIGNED30_ONE, 0) == 0 &&
                  (secp256r1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, 1) == 0 ||
                   secp256r1_modinv32_mul_cmp_30(&f, len, &modinfo->modulus, -1) == 0)));
#endif

    /* Optionally negate d, normalize to [0,modulus), and return it. */
    secp256r1_modinv32_normalize_30(&d, f.v[len - 1], modinfo);
    *x = d;
}

#endif /* SECP256R1_MODINV32_IMPL_H */
