#ifndef SECP256R1_INT128_H
#define SECP256R1_INT128_H

#include "util.h"

#if defined(SECP256R1_WIDEMUL_INT128)
#  if defined(SECP256R1_INT128_NATIVE)
#    include "int128_native.h"
#  elif defined(SECP256R1_INT128_STRUCT)
 ...
 */
static SECP256R1_INLINE void secp256r1_i128_rshift(secp256r1_int128 *r, unsigned int b);
