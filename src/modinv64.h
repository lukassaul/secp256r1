...
#ifndef SECP256R1_MODINV64_H
#define SECP256R1_MODINV64_H
...
#ifndef SECP256R1_WIDEMUL_INT128
...
typedef struct {
    int64_t v[5];
} secp256r1_modinv64_signed62;

typedef struct {
    /* The modulus in signed62 notation, must be odd and in [3, 2^256]. */
    secp256r1_modinv64_signed62 modulus;

    /* modulus^{-1} mod 2^62 */
    uint64_t modulus_inv62;
} secp256r1_modinv64_modinfo;
