...
#ifndef SECP256R1_MODINV32_H
#define SECP256R1_MODINV32_H
...
typedef struct {
    int32_t v[9];
} secp256r1_modinv32_signed30;

typedef struct {
    /* The modulus in signed30 notation, must be odd and in [3, 2^256]. */
    secp256r1_modinv32_signed30 modulus;

    /* modulus^{-1} mod 2^30 */
    uint32_t modulus_inv30;
} secp256r1_modinv32_modinfo;
